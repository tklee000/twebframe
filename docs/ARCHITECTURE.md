...
TWebFrame 0.6 is a Windows-native HTML UI runtime for C and C++ hosts. It follows a browser-like processing pipeline within a deliberately smaller scope:
...
Page loading is synchronous in version 0.6:
